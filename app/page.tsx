            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-2xl text-sm text-muted-foreground md:text-base">
                  ...
                  experience from a 10-month placement and my current role as a
                  Software Developer, I combine technical expertise with a drive
                  to solve real-world problems through clean, efficient code.
                </p>
              </div>
              ...
              <div className="card-section space-y-4">
                ...
                <dl className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <dd className="text-right">
                      Currently employed as a Software Developer, working across
                      the stack in a .NET-focused environment.
                    </dd>
                  </div>
                  <div className="flex items-start justify-between gap-4">
                    <dt className="text-xs uppercase tracking-[0.18em]">
          ...
          <div className="grid gap-10 md:grid-cols-[minmax(0,2fr)_minmax(0,1.4fr)]">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                Queen&apos;s University Belfast, graduating in July 2025. I have
                10 months of professional experience as a Placement Software
                Engineer and I am currently employed as a Software Developer.
                My journey in tech is driven by curiosity, continuous learning,
                and a commitment to writing code that&apos;s both functional and
                elegant.
              </p>
              <p className="text-sm text-muted-foreground">
                My approach combines solid engineering fundamentals with modern
                development practices. I believe in building solutions that are
                maintainable, scalable, and genuinely useful. Whether I&apos;m
                architecting backend systems or crafting intuitive user
                interfaces, I focus on delivering value through thoughtful
            ...
            <article className="card-section space-y-3">
              <header className="flex flex-wrap items-baseline justify-between gap-2">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">2025 – Present</p>
                </div>
                <span className="badge-success">Currently employed</span>
              </header>

              <p className="text-sm text-muted-foreground">
                Currently employed as a Software Developer, working primarily in
                a .NET-focused environment. I contribute to the design,
              ...
              <ul className="mt-2 space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  · Participate in code reviews, sharing feedback and improving
